...
class MakeServiceController extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $name = 'app:make-service-controller';
     ...
     * @var string
     */
    protected $description = 'Create a service controller for the specified model.';
    ...
    {
        return base_path('stubs/controller/controller-service.stub');
    }
