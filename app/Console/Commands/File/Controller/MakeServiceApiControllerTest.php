...
class MakeServiceApiControllerTest extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:make-service-api-controller-test';
     ...
     * @var string
     */
    protected $description = 'Make service api controller test file.';
    ...
    {
        return base_path('stubs/controller/controller-service-api-test.stub');
    }
